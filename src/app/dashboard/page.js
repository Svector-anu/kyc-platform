...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      {/* Header */}
      <div className="text-white py-12" style={{ backgroundColor: '#0046FF' }}>
        ...
        <div className="max-w-6xl mx-auto">
              ...
              <div className="grid gap-3">
                {credentials.map((cred) => (
                  <button
                    ...
                    style={selectedCredential?.id === cred.id ? {
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div
                          ...
                          style={{
                            backgroundColor: selectedCredential?.id === cred.id ? '#0046FF' : '#D1D5DB'
                          }}
                        >
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 mb-8">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center">
                <div className="w-16 h-16 rounded-xl flex items-center justify-center mr-4" style={{ backgroundColor: '#61DA53' }}>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 rounded-xl flex items-center justify-center mr-3" style={{ backgroundColor: '#0046FF' }}>
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Export Options */}
          <div className="rounded-2xl shadow-lg p-8 text-white" style={{ backgroundColor: '#0046FF' }}>
