        ...
        <div className="relative w-full max-w-2xl bg-white rounded-2xl shadow-2xl transform transition-all">
          ...
          <div className="p-8">
            ...
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl mb-4 shadow-lg" style={{ backgroundColor: '#0046FF' }}>
              ...
              <p className="text-gray-600">
                Verify your identity using zero-knowledge cryptography
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-1 text-white py-3 rounded-xl font-semibold hover:shadow-lg hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 transition-all duration-200 flex items-center justify-center"
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              <div className="flex items-start text-sm text-gray-600">
                ...
                <p>
                  Your data is secured with zero-knowledge cryptography. We only verify your age eligibility without storing your date of birth.
                </p>
              </div>
            </div>
          </div>
